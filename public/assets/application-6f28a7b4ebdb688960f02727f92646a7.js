...
(function() {
  $(document).ready(function() {
    var specSum, updatePreSums;
    updatePreSums = function() {
...
(function() {
  $(document).ready(function() {
    var clr, clr_name, optSum, opts, prepSum, preps, totalSum, updateSums;
    clr = "#ffffff";
    clr_name = "White";
    totalSum = 0;
    optSum = 0;
    ...
    $("#engines li").click(function(e) {
      $("#engines li").each(function() {
    ...
    $(".colors .new-color").click(function(e) {
      $(".colors div").each(function() {
        $(this).removeClass("clr-selected");
        $(this).text("");
      });
    ...
    $('#color').colorpicker('hide').on("changeColor", function(ev) {
